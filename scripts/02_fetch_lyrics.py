...
# -------------------- CONFIG --------------------
MANIFEST_IN = Path("data/fma_manifest_3k_5genres.csv")
MANIFEST_OUT = Path("data/fma_manifest_3k_5genres_lyrics.csv")
...
def fetch_from_lrclib(api: LrcLibAPI, artist: str, title: str) -> str | None:
    ...
    1) Try get_lyrics(track_name, artist_name) directly (docs example). :contentReference[oaicite:3]{index=3}
